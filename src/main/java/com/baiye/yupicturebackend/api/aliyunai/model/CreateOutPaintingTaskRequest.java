...
public class CreateOutPaintingTaskRequest implements Serializable {
    ...
    public static class Input {
         ...
         * 必选，图像 URL
         */
        @Alias("image_url") // 用于JSON字段名映射，处理下划线命名风格,解决json字段名称为"image_url"
    ...
    public static class Parameters implements Serializable {
         ...
         */
        //注意，上述代码中，某些字段打上了 Hutool 工具类的 @A1ias 注解，这个注解仅对 Hutool 的 JSON 转换生效,
        // 对 SpringMVC 的 JSON 转换没有任何影响。
        //前端如果传递参数名xScale，是无法赋值给 xScale 字段的;但是传递参数名 xscale，就可以赋值。
        // 这是因为 SpringMVC 对于第二个字母是大写的参数无法映射(和参数类别无关)，
        //解决方案是，给这些字段增加@JsonProperty 注解:
        @Alias("x_scale")
        @JsonProperty("xScale")// 用于JSON字段名映射，处理下划线命名风格,解决json字段名称为"xScale"
